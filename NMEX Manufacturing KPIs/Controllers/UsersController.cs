...
namespace NMEX_Manufacturing_KPIs.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel register)
        {
            try
            {
                var user = new Users()
                {
                    ...
                    IdUserNissan = register.IdUserNissan
                };
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            ...
            var resultado = await signInManager.PasswordSignInAsync(model.IdUserNissan, model.Password, model.Recuerdame, lockoutOnFailure: false);
